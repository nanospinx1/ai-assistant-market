...
const APPS_CATALOG: AppItem[] = [
  ...
  { id: "facebook", name: "Facebook", description: "Page management, post scheduling, and audience insights", category: "Social Media", icon: Globe, gradient: "from-[#1877F2] to-[#0C5DC7]", logo: "/logos/facebook.svg", popular: true, available: true },
  ...
  { id: "instagram", name: "Instagram", description: "Content publishing, stories, reels, and engagement tracking", category: "Social Media", icon: Smartphone, gradient: "from-[#F58529] to-[#DD2A7B]", logo: "/logos/instagram.svg", popular: true, available: true },
  ...
  { id: "tiktok", name: "TikTok", description: "Short-form video publishing, trends, and ad management", category: "Social Media", icon: Video, gradient: "from-[#010101] to-[#69C9D0]", logo: "/logos/tiktok.svg", available: true },
  ...
  { id: "x-twitter", name: "X (Twitter)", description: "Tweet scheduling, mentions monitoring, and trend analytics", category: "Social Media", icon: MessageSquare, gradient: "from-[#000000] to-[#333333]", logo: "/logos/x.svg", popular: true, available: true },
  ...
  { id: "youtube", name: "YouTube", description: "Video publishing, channel management, and audience analytics", category: "Social Media", icon: Video, gradient: "from-[#FF0000] to-[#CC0000]", logo: "/logos/youtube.svg", available: true },
